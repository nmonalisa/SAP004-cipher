...
* [4. Ferramentas utilizadas na construção do projeto](#4-ferramentas-utilizadas-na-construção-do projeto)
...
![caeser-cipher](https://user-images.githubusercontent.com/11894994/60990999-07ffdb00-a320-11e9-87d0-b7c291bc4cd1.png). Essa é a lógica utilizada na codificação de mensagens neste projeto.
...
## 4. Ferramentas utilizadas na construção
...
* src/cipher.js: contém o objeto cipher, que possui dois métodos:
1) cipher.encode(offset, string): usado para codificar o texto, e 2) cipher.decode(offset, string): usado para traduzir a mensagem codificada. Offset é o número de posições que queremos mover para a esquerda no alfabeto e string é a mensagem (texto) que queremos decifrar.
...
## 8. Agradecimentos
Colegas de Squad (Luana, Marcela, Mari, Marjorie, Milena, Naere, Natasha, Nathalia) e equipe Laboratoria, em especial Palomita e Mônica.